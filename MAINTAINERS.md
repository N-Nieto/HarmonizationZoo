...
This is the deep-dive companion to `README.md` — how the site's data
model, automation, and internals actually work. If you just want to run
the site or add a method, `README.md` and `CONTRIBUTING.md` are enough;
this file is for understanding *why* things are built the way they are,
debugging the pipelines, or changing how they work.
...
scripts/fetch_citations.py    fills in citation counts via Semantic Scholar (server-side only — see "Keeping GitHub stats current")
