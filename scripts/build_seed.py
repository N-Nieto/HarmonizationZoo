...
METHODS = [
    ...
    dict(id="whitestripe", name="WhiteStripe", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "white-matter", "reference-region", "individual-method"],
    ...
    dict(id="nyul", name="Nyúl–Udupa Histogram Matching", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "histogram-matching", "population-method"],
    ...
    dict(id="ravel", name="RAVEL", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "control-region", "population-method"],
    ...
    dict(id="zscore-normalization", name="Z-score Normalization", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "individual-method", "single-image"],
         paper_title=None, paper_year=None, paper_url=None,
         github=None, other_url="https://github.com/jcreinhold/intensity-normalization", language=["Python"]),
    dict(id="fcm-normalization", name="FCM (Fuzzy C-Means) Normalization", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "individual-method", "single-image", "tissue-segmentation"],
         paper_title=None, paper_year=None, paper_url=None,
         github=None, other_url="https://github.com/jcreinhold/intensity-normalization", language=["Python"]),
    dict(id="kde-normalization", name="KDE (Kernel Density Estimation) Normalization", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "individual-method", "single-image"],
         paper_title=None, paper_year=None, paper_url=None,
         github=None, other_url="https://github.com/jcreinhold/intensity-normalization", language=["Python"]),
    dict(id="lsq-normalization", name="LSQ (Least Squares) Normalization", category="classical-normalization", method_type="statistical",
         level="image-level", tags=["intensity-normalization", "population-method"],
         paper_title=None, paper_year=None, paper_url=None,
         github=None, other_url="https://github.com/jcreinhold/intensity-normalization", language=["Python"]),
    ...
    dict(id="simix", name="SiMix", category="deep-learning", method_type="deep-learning",
         level="image-level", tags=["domain-generalization", "site-mixing", "test-time-augmentation"],
         paper_title="SiMix: A domain generalization method for cross-site brain MRI harmonization via site mixing",
         paper_year=2024, paper_url="https://doi.org/10.1016/j.neuroimage.2024.120812", github=None, language=[]),
    dict(id="ssimh", name="SSIMH (Spectrum Swapping Image-level Harmonization)", category="deep-learning",
         method_type="statistical", level="image-level", tags=["spectrum-analysis", "non-learning", "fast"],
         paper_title="Fast Image-Level MRI Harmonization via Spectrum Analysis",
         paper_year=2022, paper_url="https://doi.org/10.1007/978-3-031-21014-3_21", github=None, language=[]),
    dict(id="diffusion-autoencoder-harmonization", name="Conditioned Diffusion Autoencoder Harmonization (Scholz et al.)",
         category="deep-learning", method_type="deep-learning", level="image-level",
         tags=["diffusion-model", "contrastive-loss", "reference-image"],
         paper_title="A Domain-General MRI Harmonization Method",
         paper_year=2025, paper_url="https://papers.miccai.org/miccai-2025/paper/1897_paper.pdf", github=None, language=[]),
    dict(id="style-guided-latent-diffusion", name="Unpaired Multi-Site Harmonization via Style-Guided Latent Diffusion",
         category="deep-learning", method_type="deep-learning", level="image-level",
         tags=["diffusion-model", "unpaired", "CLIP-loss"],
         paper_title="Unpaired Multi-Site Brain MRI Harmonization with Image Style-Guided Latent Diffusion",
         paper_year=2025, paper_url="https://papers.miccai.org/miccai-2025/0980-Paper3175.html", github=None, language=[]),
    dict(id="attention-guided-domain-adaptation", name="Attention-Guided Deep Domain Adaptation (Guan et al.)",
         category="deep-learning", method_type="deep-learning", level="feature-level",
         tags=["domain-adaptation", "attention", "disease-classification"],
         paper_title="Multi-site MRI harmonization via attention-guided deep domain adaptation for brain disorder identification",
         paper_year=2021, paper_url="https://doi.org/10.1016/j.media.2021.102076", github=None, language=[]),
    dict(id="blindharmony", name="BlindHarmony", category="deep-learning", method_type="deep-learning",
         level="image-level", tags=["normalizing-flows", "blind-harmonization", "source-free"],
         paper_title="BlindHarmony: \"Blind\" Harmonization for MR Images via Flow model",
         paper_year=2023, paper_url="https://arxiv.org/abs/2305.10732", github=None, language=[]),
    dict(id="blindharmonydiff", name="BlindHarmonyDiff", category="deep-learning", method_type="deep-learning",
         level="image-level", tags=["diffusion-model", "blind-harmonization", "edge-guided"],
         paper_title="Efficient and robust 3D blind harmonization for large domain gaps",
         paper_year=2025, paper_url="https://arxiv.org/abs/2505.00133", github=None, language=[]),
    dict(id="tgtfreeharmony", name="TgtFreeHarmony", category="deep-learning", method_type="deep-learning",
         level="image-level", tags=["target-free", "privacy-preserving", "no-data-sharing"],
         paper_title="A Target-Free Harmonization Method for MRI",
         paper_year=2026, paper_url="https://arxiv.org/abs/2605.01282",
         github="SNU-LIST/TgtFreeHarmony", language=["Python"]),
    dict(id="gnn-connectome-harmonization", name="GNN Structural Connectome Harmonization",
         category="deep-learning", method_type="deep-learning", level="feature-level",
         tags=["graph-neural-network", "connectome", "diffusion-MRI", "no-metadata-needed"],
         paper_title="Structural Connectome Harmonization Using Deep Learning: The Strength of Graph Neural Networks",
         paper_year=2025, paper_url="https://arxiv.org/abs/2507.13992", github=None, language=[]),
    dict(id="connectome-distribution-matching", name="Structural Connectivity Harmonization via Distribution Matching",
         category="optimal-transport", method_type="statistical", level="feature-level",
         tags=["connectome", "diffusion-MRI", "distribution-matching"],
         paper_title="Harmonization of Structural Brain Connectivity Through Distribution Matching",
         paper_year=2025, paper_url=None, github=None, language=[]),
    dict(id="ssim-guided-disentanglement", name="Scanner-Agnostic MRI Harmonization via SSIM-Guided Disentanglement",
         category="deep-learning", method_type="deep-learning", level="image-level",
         tags=["disentanglement", "SSIM-loss", "style-transfer"],
         paper_title="Scanner-Agnostic MRI Harmonization via SSIM-Guided Disentanglement",
         paper_year=2025, paper_url="https://arxiv.org/abs/2510.22073", github=None, language=[]),
    dict(id="dist-clip", name="DIST-CLIP", category="deep-learning", method_type="deep-learning",
         level="image-level", tags=["CLIP", "disentanglement", "text-guided", "zero-shot"],
         paper_title="DIST-CLIP: Arbitrary Metadata and Image Guided MRI Harmonization via Disentangled Anatomy-Contrast Representations",
         paper_year=2025, paper_url="https://arxiv.org/abs/2512.07674", github=None, language=[]),
...
MODALITY = {
    ...
    "zscore-normalization": "Structural MRI", "fcm-normalization": "Structural MRI",
    "kde-normalization": "Structural MRI", "lsq-normalization": "Structural MRI",
    ...
    "simix": "Structural MRI", "ssimh": "Structural MRI",
    "diffusion-autoencoder-harmonization": "Structural MRI",
    "style-guided-latent-diffusion": "Structural MRI",
    "attention-guided-domain-adaptation": "Structural MRI",
    "gnn-connectome-harmonization": "Diffusion MRI (structural connectomes)",
    "connectome-distribution-matching": "Diffusion MRI (structural connectomes)",
    "ssim-guided-disentanglement": "Structural MRI", "dist-clip": "Structural MRI",
    "blindharmony": "Structural MRI", "blindharmonydiff": "Structural MRI",
    "tgtfreeharmony": "Structural MRI",
...
RECOMMEND_OVERRIDES = {
    ...
    # Domain generalization to an unseen site is literally SiMix's stated contribution.
    "simix": dict(generalizes_to_new_site=True),
    # Explicitly "without requiring fine-tuning" per the paper's own framing.
    "diffusion-autoencoder-harmonization": dict(generalizes_to_new_site=True),
    # "Blind"/"target-free" harmonization is explicitly, definitionally about
    # working on domains never seen during training — that's the whole point
    # of the concept, not an incidental property.
    "blindharmony": dict(generalizes_to_new_site=True),
    "blindharmonydiff": dict(generalizes_to_new_site=True),
    "tgtfreeharmony": dict(generalizes_to_new_site=True, requires_site_id=False),
}
...
ARCHITECTURE_BACKBONE = {
    ...
    "simix": "CNN (site-mixing augmentation)",
    "diffusion-autoencoder-harmonization": "Diffusion model",
    "style-guided-latent-diffusion": "Diffusion model",
    "attention-guided-domain-adaptation": "Adversarial network (attention-guided)",
    "gnn-connectome-harmonization": "Graph Neural Network",
    "ssim-guided-disentanglement": "Disentangled autoencoder (AGUIT-based)",
    "dist-clip": "CLIP-guided disentanglement",
    "blindharmony": "Normalizing flow", "blindharmonydiff": "Diffusion model",
